...
let validateRegister = [
    ...
    body('password', 'Mật khẩu không thể rỗng!').isEmpty(),
    ...
    body('firstname', 'Tên không thể rỗng!').isEmpty(),
    body('lastname', 'Họ không thể rỗng!').isEmpty(),
    body('birthday', 'Sinh nhật không thể trống!').isEmpty(),
    body('birthday', 'Ngày sinh không đúng định dạng!').isISO8601('yyyy-mm-dd'),
    body('gender', 'Giới tính không thể rỗng!').isEmpty(),
];
