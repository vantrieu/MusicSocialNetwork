...
exports.delete = async function (req, res) {
    ...
    let tracktype = await TrackType.findOne({ _id: typeID }, ['_id', 'typename', 'description', 'isDelete', 'createdAt']);
...
exports.getlist = async function (req, res) {
    let tracktypes = await TrackType.find({ isDelete: { "$ne": 1 } }, ['_id', 'typename', 'description', 'isDelete', 'createdAt']);
...
exports.getone = async function (req, res) {
    ...
    let tracktype = await TrackType.findOne({ isDelete: { "$ne": 1 }, _id: typeID }, ['_id', 'typename', 'description', 'isDelete', 'createdAt']);
    tracktype._doc.createdAt = moment(tracktype._doc.createdAt).format('DD/MM/YYYY');
    responsehandler(res, 200, 'Successfully', tracktype, null);
}
...
exports.modify = async function (req, res) {
    ...
    let tracktype = await TrackType.findOne({ _id: typeID }, ['_id', 'typename', 'description', 'createdAt']);
    tracktype._doc.createdAt = moment(tracktype._doc.createdAt).format('DD/MM/YYYY');
    responsehandler(res, 200, 'Successfully', tracktype, null);
}